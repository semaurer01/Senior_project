...
constexpr int mpu_offsets = {-1009, -623, 18460, -263, -977, -272, 309};
...
void bluetooth(int status){ //debugging data this will be commented out during competition 
  switch(status){
...
void mpu(){
  Wire.beginTransmission(MPU6050_ADDR);
    ...
    Wire.requestFrom(MPU6050_ADDR, 14);  // Request 14 bytes (6 for accelerometer, 6 for gyroscope, 2 temparature currently ignored)
  for(int i=0;i<8){//loop through the data 
